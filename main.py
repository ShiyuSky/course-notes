...
# Add "_orig" at the end of image datasets (train and test)
# because we are going to preprocess them. After preprocessing, we
# will end up with train_set_x and test_set_x (the labels train_set_y
